...
import { Datas } from '../../Zepeto Multiplay Component/ZepetoScript/Managers/TypeManager';
...
export default class ScreenShotController extends ZepetoScriptBehaviour {
    ...
    public CreateFeedScreenShot() {
        ZepetoWorldContent.CreateFeed(this.renderTexture, Datas.FeedMessage, (result: boolean) => {
